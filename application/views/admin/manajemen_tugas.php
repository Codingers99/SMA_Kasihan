            ...
            <div class="container-xxl">
                <div class="container p-0">
                    ...
                    <div class="bg-white p-3">
                        <div class="container_btn_tambah_data">
                            Daftar Topik Tugas / Quiz
                            <a href="<?php echo base_url()?>index.php/admin/add_manajemen_tugas.php">
                                <div class="btn btn-primary m-0 btn_tambah_data">
                                    Tambah Data
                                </div>
                            </a>
                        </div>
                            ...
                            <table class="table table-striped table-bordered border-dark align-middle">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>03 Juli 2023</td>
                                        <td>60 menit</td>
                                        <td>Ulangan tgl 04-08-2023</td>
                                        <td>
                                            <a href="<?php echo base_url()?>index.php/admin/nilai_manajemen_tugas.php">
                                                <div class="btn btn-primary p-1 px-2">
                                                Lihat
                                                </div>
                                            </a>
                                        </td>
                                        <td> 
                                            <a class="" href="<?php echo base_url()?>index.php/admin/edit_manajemen_tugas.php">
                                                <div class="btn btn-warning p-1 px-2 me-1 text-white">
                                                Edit
                                                </div>
                                            </a>
                                            <a class="" href="<?php echo base_url()?>index.php/admin/hapus_manajemen_tugas.php">
