        ...
        <div class="container-fluid pt-3 p-0 pb-5 bg_color3" id="back">
            <div class="container-xxl">
                <div class="container p-0">
                    ...
                    <div class="nama_tugas">
                        <h1>Nama Pengirim Tugas</h1>
                    </div>

                    <div class="view_tugas">
                        <embed class="w-100" type="application/pdf" src="Program 1.pdf">
                    </div>

                    <div class="bg-white container_kolom_nilai">
                        <div class="d-flex justify-content-center text_kolom_nilai">
                            Nilai
                        </div>
                        <form action="">
                            <input type="text">
