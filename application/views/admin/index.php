...
<html lang="en">
    ...
    <body>
        ...
        <!-- content -->
        <div class="container-fluid pt-3 p-0 bg_color3" id="back">
            <div class="container-xxl">
                <div class="container p-0">
                    ...
                    <div class="row align-items-center justify-content-center container_content_admin">
                        <img class="col-lg-4 col-md-4 col-sm-4 col-12 px-3" src="<?php echo base_url(); ?>asset/materi_admin.png" alt="">
                        <img class="col-lg-4 col-md-4 col-sm-4 col-12 px-3" src="<?php echo base_url(); ?>asset/tugas_admin.png" alt="">
                        <img class="col-lg-4 col-md-4 col-sm-4 col-12 px-3" src="<?php echo base_url(); ?>asset/datakelas_admin.png" alt="">
                    </div>
                </div>
            </div>
        </div>
