...
<html lang="en">
    ...
    <body>
        ...
        <!-- content -->
        <div class="container-fluid container_height pt-3 p-0 pb-5 bg_color3" id="back">
            <div class="container-xxl">
                <div class="container p-0">
                    ...
                    <div class="bg-white p-3">
                        <a href="<?php echo base_url()?>index.php/admin/tambah_manajemen_kelas">
                            ...
                            <table class="table table-striped table-bordered border-dark align-middle">
                                ...
                                <!-- perulangan -->
                                    ...
                                    <tr>
                                        ...
                                        <td>ajjskjbx</td>
                                        <td> 
                                        <a class="" href="<?php echo base_url()?>index.php/admin/<?php echo base_url()?>index.php/admin/edit_manajemen_kelas.php">
                                            <div class="btn btn-warning p-1 px-2 me-1 text-white">
                                            Edit
                                            </div>
                                        </a>
                                        <a class="" href="<?php echo base_url()?>index.php/admin/<?php echo base_url()?>index.php/admin/hapus_manajemen_kelas.php">
                                            <div class="btn btn-danger p-1 px-2 me-1">
                                            Hapus
                                            </div>
                                        </a>
                                        <a class="" href="<?php echo base_url()?>index.php/admin/<?php echo base_url()?>index.php/admin/lihat_siswa_manajemen_kelas.php">
                                            <div class="btn btn-secondary p-1 px-2">
                                            Lihat Siswa
                                            </div>
                                        </a>
                                        </td>
                                ...
                                <!-- perulangan -->
                                    ...
                                    <tr>
                                        ...
                                        <td>ajjskjbx</td>
                                        <td>
                                        <a class="" href="<?php echo base_url()?>index.php/admin/edit_manajemen_kelas.php">
                                            <div class="btn btn-warning p-1 px-2 me-1 text-white">
                                            Edit
                                            </div>
                                        </a>
                                        <a class="" href="<?php echo base_url()?>index.php/admin/hapus_manajemen_kelas.php">
                                            <div class="btn btn-danger p-1 px-2 me-1">
                                            Hapus
                                            </div>
                                        </a>
                                        <a class="" href="<?php echo base_url()?>index.php/admin/lihat_siswa_manajemen_kelas.php">
                                            <div class="btn btn-secondary p-1 px-2">
                                            Lihat Siswa
                                            </div>
                                        </a>
