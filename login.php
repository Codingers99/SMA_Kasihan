    ...
    <div class="container-fluid py-2 bg_color1">
        ...
        <div class="row">
            ...
            <div class="row h-100 justify-content-center align-items-center">
                <a class="d-flex bg_color2 border_color1 btn_navbar align-items-center justify-content-center" href="home.php">HOME</a>
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex h-100 justify-content-center align-items-center">
            <div class="d-block">
                ...
                <form>
                    <input type="text" class="form-control input_login" placeholder="Masukkan Username">
                    <input type="text" class="form-control my-lg-3 my-md-3 my-sm-3 my-2 input_login" placeholder="Masukkan Password">
